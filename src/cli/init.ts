...
export async function runInit(opts: InitOptions = {}) {
  ...
  console.log(
    boxen(
      `${chalk.bold.hex('#14F195')('⚡ git-bounty Initialization')}\n` +
      `${chalk.gray('Configure your repository for Gibwork Solana bounties')}`,
      { padding: 1, margin: 0, borderStyle: 'round', borderColor: 'green' }
    )
  );
