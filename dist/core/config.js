...
import { GitBountyConfigSchema } from '../types/config.js';
 ...
 */
export function recordBounty(record, dir = process.cwd()) {
 ...
 */
export function getBountyRecord(identifier, dir = process.cwd()) {
    const config = loadConfig(dir);
 ...
 */
export function resolvePrivateKey(cliKeypairPath) {
