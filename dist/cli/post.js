...
export async function runPost(issueNumberStr, opts) {
    ...
    try {
        ...
        console.log(boxen(`${chalk.bold.hex('#14F195')('Bounty Parameters')}\n` +
            ...
            `• Mint: ${chalk.gray(tokenMint)}`, { padding: 1, margin: { top: 1, bottom: 1 }, borderStyle: 'round', borderColor: 'green' }));
        if (opts.dryRun) {
